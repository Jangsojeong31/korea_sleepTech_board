...
// 게시글 단건 조회
export const GET_BOARD_URL = (boardId: number | string) => `${BOARD_MODULE_URL}/${boardId}`; // 화살표 함수
...
// 댓글 삭제
export const DELETE_COMMENT_URL = (boardId: number | string, commentId: number) => `${BOARD_MODULE_URL}/${boardId}/comments/${commentId}`;
